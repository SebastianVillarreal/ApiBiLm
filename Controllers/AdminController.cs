...
namespace marcatel_api.Controllers
{
    ...
    public class AdminController: ControllerBase
    {
        ...
        [HttpGet("GetVentasFamiliaSucursalSirota")]
        public JsonResult GetVentasFamiliaSucursalSirota(int sucursal, string f_inicial, string f_final)
        {
            var objectResponse = Helper.GetStructResponse();
            try
            {
                var articulo = _adminService.GetVentasFamiliaSucursalSirota( f_inicial, f_final, sucursal);
                objectResponse.StatusCode = (int)HttpStatusCode.OK;
                objectResponse.success = true;
                objectResponse.message = "data cargado con exito";
